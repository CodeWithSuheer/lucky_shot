            ...
            <div className="max-w-[85rem] px-1 py-10 sm:px-6 lg:px-2 lg:py-4 mx-auto">
                ...
                <div className="flex justify-between flex-wrap items-center text-white">
                    ...
                    <div className='bg-[#676767] text-gray-200 px-3 py-2.5 mt-2 sm:mt-0 rounded-md flex items-center gap-6'>
                        <input type='date' name='date' placeholder='Select Date' value={date} onChange={(e) => setdate(e.target.value)} className='bg-[#676767]  placeholder:text-sm sm:placeholder:text-md text-sm text-white onFoucs:border-none accent-[#B600D4] focus:outline-none focus:ring-0' />
                    </div>
                </div>
