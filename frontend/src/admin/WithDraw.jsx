                                                ...
                                                <td className="h-px w-px whitespace-nowrap">
                                                    <div className="ps-6 lg:ps-3 xl:ps-6 pe-6 py-4">
                                                        <div className="flex items-center gap-x-3">
                                                            {Selected ? ( // Conditionally render circle element
                                                                <span className="bg-[#00c14d] rounded-full h-3 w-3" onClick={()=> handleselected}></span>
                                                            ):(
                                                                <span className=" border-2 border-[#00c14d] rounded-full h-3 w-3" onClick={() => handleselected}></span>   
                                                            )
                                                        }
