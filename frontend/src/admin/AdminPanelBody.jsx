            ...
            <div className={`bg-black `}>
                ...
                <div className="w-full pt-10 px-4 border-t border-[#B600D4] sm:px-6 md:px-8 lg:ps-72">
                    ...
                    {/* <header>
                        ...
                        <h1 className="block text-2xl font-bold text-gray-800 sm:text-3xl text-white">Application Layout: Sidebar using Tailwind CSS</h1>
                        <p className="mt-2 text-lg text-gray-800 text-gray-400">This is a simple application layout with sidebar and header examples using Tailwind CSS.</p>
                        <div className="mt-5 flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
                            ...
                            <a className="w-full sm:w-auto py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none text-blue-500 hover:text-blue-400 focus:outline-none focus:ring-1 focus:ring-gray-600" href="../examples.html">
